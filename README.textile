...
It is reasonable to run six MySQL servers on a MacBook Pro with decent performance.  This script is intended for development and experimentation.  Another version (_cloud-repctl_) will handle replication related operations between MySQL server instances in a cloud environment.
